...
public class vocabController {
	...
	public String DetalVocab(@RequestParam int idVocab, Model model) {
		...
		BaiTapTuVung baitaptuvung = baitaptuvungService.getBaiTapTuVung(idVocab).get(0);

		model.addAttribute("baitaptuvung", baitaptuvung);
		model.addAttribute("idBaiTapTuVung", baitaptuvung.getBaitaptuvungid());
