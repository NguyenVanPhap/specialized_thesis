$(document).ready(function() {
	...
	function ajaxGet(page) {
		...
		$.ajax({
			type: "GET",
			url: "/api/admin/readingexercise/getall" + "?page=" + page + "&level=" + level + "&part=" + part,
	...
	$(document).on('click', '.btnUpdateReadingExercise', function(event) {
		...
		var href = domain + "/api/admin/readingexercise/" + baiDocId;
	...
	function saveFunction(formData) {
		...
		$.ajax({
			...
			url: "/api/admin/readingexercise/add",
	...
	function updateFunction(formData, id) {
		...
		$.ajax({
			...
			type: "POST",
			contentType: "application/json",
			url: "/webtoeic/api/admin/readingexercise/update/" + id,
			enctype: 'multipart/form-data',
			data: formData,
			// prevent jQuery from automatically transforming the data into a
			// query string
